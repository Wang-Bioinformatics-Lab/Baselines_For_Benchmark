...
python3 train_presampled.py --train_path $OLD_DATA_DIR"/processed/data/ALL_GNPS_positive_train_split.pickle" \
                            ...
                            --presampled_train_data_dir $DATA_DIR"processed/data/presampled_filtered_training_data/data.hdf5" \
                            --presampled_val_data_dir $DATA_DIR"/processed/data/presampled_filtered_validation_data/data.hdf5" \
                            --save_dir "./asms/" \
                            --loss_bias_multiplier 10.0 \
                            -lr 1e-4
