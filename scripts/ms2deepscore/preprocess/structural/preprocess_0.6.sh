...
python3 preprocess_data.py --train_spectra $POSITIVE_DATA_DIR"/train_rows_structural_${SIMILARITY_THRESHOLD}.mgf" \
                            ...
                            --save_dir "./structural_similarity/${SIMILARITY_THRESHOLD}/"
