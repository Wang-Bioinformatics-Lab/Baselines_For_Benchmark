...
rsync -rP labvm:/home/user/SourceCode/GNPS_ML_Processing_Workflow/Train_Test_Splits/nf_output/Structural_Similarity_Prediction/structure_3484/ \
          ./raw/
...
python3 get_positive.py --input_dir "./random_inchikey_3484/raw/" \
                        --output_dir "./random_inchikey_3484/raw/positive/"

### PREPROCESS NEW DATA
echo "----------------------------------------"
echo "PREPROCESSING NEW DATA"
POSITIVE_DATA_DIR="../../data/random_inchikey_3484/raw/positive/"
DATA_DIR="../../data/random_inchikey_3484/raw"
SAVE_DIR="../../data/random_inchikey_3484/processed/"
BIN_DIR="../src/shared/"
