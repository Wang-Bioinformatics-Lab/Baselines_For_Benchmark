...
mkdir -p  $DATA_DIR"/processed/data/presampled_basic_training_data_03_10/logs"
...
python3 ./presample_pairs_generic.py  --train_path $DATA_DIR"/processed/data/ALL_GNPS_positive_train_split.pickle" \
                                    ...
                                    --save_dir $DATA_DIR"/processed/data/presampled_basic_validation_data_03_10" \
                                    --num_epochs 150 \
                                    --num_bins 10 \
                                    --exponential_bins 0.30


mkdir -p  $DATA_DIR"/processed/data/presampled_basic_validation_data_03_10/logs"
