...
mkdir -p  $DATA_DIR"/processed/data/presampled_basic_training_data_20/logs"
...
python3 ./presample_pairs_generic.py  --train_path $DATA_DIR"/processed/data/ALL_GNPS_positive_train_split.pickle" \
                                    ...
                                    --save_dir $DATA_DIR"/processed/data/presampled_basic_training_data_20" \
                                    --num_epochs 150 \
                                    --num_bins 20


mkdir -p  $DATA_DIR"/processed/data/presampled_basic_validation_data_20/logs"

python3 ./presample_pairs_generic.py --train_path $DATA_DIR"/processed/data/ALL_GNPS_positive_val_split.pickle" \
                                    --tanimoto_scores_path $DATA_DIR"/processed/train_tanimoto_df.csv" \
                                    --save_dir $DATA_DIR"/processed/data/presampled_basic_validation_data_20" \
                                    --num_epochs 1 \
                                    --num_turns 10 \
                                    --num_bins 20
