...
python3 train_presampled.py --train_path $OLD_DATA_DIR"/processed/data/ALL_GNPS_positive_train_split.pickle" \
                            ...
                            --presampled_train_data_dir $DATA_DIR"processed/data/presampled_basic_training_data_03_10/data.hdf5" \
                            --presampled_val_data_dir $DATA_DIR"/processed/data/presampled_basic_validation_data_03_10/data.hdf5" \
                            --save_dir "./asms/" \
                            -lr 5e-5
